...
int Is_CamResult_NG2(Bolt* bolt)
{
	...
	if (*(cam0.pEnable) == 1)
	{
		...
		if ((bolt->cam[0] == CAM_NG2) || (bolt->cam[0] == CAM_NG3))
			countNG2orNG3++;
		else if ((bolt->cam[0] == CAM_OK) || (bolt->cam[0] == CAM_NG1))
			;
		else
			return -1;
	}
	...
	if (*(cam1.pEnable) == 1)
	{
		...
		if ((bolt->cam[1] == CAM_NG2) || (bolt->cam[1] == CAM_NG3))
			countNG2orNG3++;
		else if ((bolt->cam[1] == CAM_OK) || (bolt->cam[1] == CAM_NG1))
			;
		else
			return -1;
	}
	...
	if (*(cam2.pEnable) == 1)
	{
		...
		if ((bolt->cam[2] == CAM_NG2) || (bolt->cam[2] == CAM_NG3))
			countNG2orNG3++;
		else if ((bolt->cam[2] == CAM_OK) || (bolt->cam[2] == CAM_NG1))
			;
		else
			return -1;
	}
	...
	if (*(cam3.pEnable) == 1)
	{
		...
		if ((bolt->cam[3] == CAM_NG2) || (bolt->cam[3] == CAM_NG3))
			countNG2orNG3++;
		else if ((bolt->cam[3] == CAM_OK) || (bolt->cam[3] == CAM_NG1))
			;
		else
			return -1;
	}
